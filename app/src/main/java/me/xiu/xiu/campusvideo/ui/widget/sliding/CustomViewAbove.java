...
public class CustomViewAbove extends FrameLayout {
    ...
    private SlidingLayout.OnClosedListener mClosedListener;
    private SlidingLayout.OnOpenedListener mOpenedListener;
    ...
    public void setOnClosedListener(SlidingLayout.OnClosedListener l) {
        mClosedListener = l;
    }
    ...
    protected int mTouchMode = SlidingLayout.TOUCHMODE_MARGIN;
    ...
    private boolean thisTouchAllowed(MotionEvent ev) {
        ...
        if (isMenuOpen()) {
            ...
            switch (mTouchMode) {
                ...
                case SlidingLayout.TOUCHMODE_NONE:
                    return false;
    ...
    public void scrollTo(int x, int y) {
        ...
        ((SlidingLayout) getParent()).manageLayers(getPercentOpen());
    }
