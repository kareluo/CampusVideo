 ...
 */
public class VideoView extends SurfaceView implements MediaPlayerControlable {
    ...
    private MediaControlable mMediaController;
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                ...
                new AlertDialog.Builder(mContext)
                        ...
                        .setMessage(message).setPositiveButton(R.string.VideoView_error_button,
    ...
    private void openVideo() {
        ...
        mContext.sendBroadcast(new Intent("com.android.music.musicservicecommand").putExtra("command", "pause"));
    ...
    public void setMediaController(MediaControlable controller) {
        if (mMediaController != null)
            mMediaController.hide();
